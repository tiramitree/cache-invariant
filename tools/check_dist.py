...
SDIST_REPRODUCIBILITY_FILES = {
    ...
    "evidence/reference-v0.2.0-windows/evidence.json",
    "evidence/reference-v0.2.0-windows/junit.xml",
    "evidence/reference-v0.2.0-windows/manifest.json",
    "evidence/reference-v0.3.0-windows/evidence.json",
    "evidence/reference-v0.3.0-windows/junit.xml",
    "evidence/reference-v0.3.0-windows/manifest.json",
    "tests/conftest.py",
